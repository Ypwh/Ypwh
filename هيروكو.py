...
Heroku_cmd = (
    "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝑹𝑬𝑷𝑻𝑯𝑶𝑵🜑 - هيـروكو الفـارات](https://t.me/Repthon) 𓆪\n"
    "**⌔∮ قائـمه اوامر هيروكو :** \n"
    "⪼ `.ضع فار` + الفار + المتغير\n"
    "⪼ `.جلب فار` + الفار لعرض ما في المتغير \n"
    "⪼ `.حذف فار` + الفار لحذف الفار \n"
    "⪼ `.استخدامي` \n"
    "\n𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝑹𝑬𝑷𝑻𝑯𝑶𝑵🜑](https://t.me/Repthon) 𓆪"
)
        ...
        try:
            ...
            if variable in heroku_var:
                return await ics.edit(
                    "𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝑹𝑬𝑷𝑻𝑯𝑶𝑵🜑 - 𝑮𝑶𝑵𝑭𝑰𝑮 𝑽𝑨𝑹𝑺 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"
...
async def _(dyno):
    ...
    try:
        ...
        return await dyno.reply(
            "**- عذرا لا يمكنك استخدام اوامر الفارات وهيروكو الا بعد اضافة كود هيروكو الى الفارات شرح الاضافة [اضغط هنا](https://t.me/Repthon)**"
        )
    data = app.get_log()
    await edit_or_reply(
